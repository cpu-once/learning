...
public class HashTableSearchSynCollisionTrace {
  ...
  public static void main(String[] args) {
    int data, hashValue;
    int pos; // 저장할 위치, 검색 위치

    // 키보드로 데이터를 입력하면 해시 테이블에 저장
    ...
    do {
      ...
      if (hashTable[pos] == -1) {
        ...
        System.out.printf("헤시 테이블이 가득 찼습니다.\n");
      }
    } while (true);
    ...
    do {
      ...
      if (hashTable[pos] == data) {
        System.out.printf("hashTable[%d]값은 %d이므로, 발결한 위치를 표시합니다.\n", pos, data);
